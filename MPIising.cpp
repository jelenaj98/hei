...
int MPIising::metropolis()
{
   ...
   return count_attempt, count_accepted; 
}   
...
void MPIising::output(double temperature, double E, int count_accepted,int count_attempt)
{
...
{    
    int count_accepted, count_attempt;
    ...
    double  average[6], initial_temp=2.4, final_temp=2.4, temp_step=0.05;
    /*
    ...
    */
    ...
    for ( double temperature = initial_temp; temperature <= final_temp; temperature+=temp_step){
        ...
        for (int cycles = myloop_begin; cycles <= myloop_end; cycles++){
            count_accepted, count_attempt= metropolis();
        ...
        bool output_mcs = true;
         // print results
        if ( output_mcs) {
            cout << count_attempt << "     "<< count_accepted;
            output(temperature, E,count_accepted,count_attempt);
        }
        }
